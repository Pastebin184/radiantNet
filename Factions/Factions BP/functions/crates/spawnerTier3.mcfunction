...
execute as @s[hasitem={item=radiant:spawner_tier_3}] run execute if score randomCrate2 random matches 0..75 run clear @s radiant:spawner_tier_3 0 1 
...
execute as @s[hasitem={item=radiant:spawner_tier_3}] run execute if score randomCrate2 random matches 76..98 run clear @s radiant:spawner_tier_3 0 1 
...
execute as @s[hasitem={item=radiant:spawner_tier_3}] run execute if score randomCrate2 random matches 99..100 run clear @s radiant:spawner_tier_3 0 1 
...
execute as @s[hasitem={item=radiant:spawner_tier_3}] run execute if score @s spawnerPity_3 matches 100.. run clear @s radiant:spawner_tier_3 0 1 
