...
execute as @s[hasitem={item=radiant:spawner_tier_2}] run execute if score randomCrate2 random matches 0..75 run clear @s radiant:spawner_tier_2 0 1 
...
execute as @s[hasitem={item=radiant:spawner_tier_2}] run execute if score randomCrate2 random matches 76..98 run clear @s radiant:spawner_tier_2 0 1 
...
execute as @s[hasitem={item=radiant:spawner_tier_2}] run execute if score randomCrate2 random matches 99..100 run clear @s radiant:spawner_tier_2 0 1 
...
execute as @s[hasitem={item=radiant:spawner_tier_2}] run execute if score @s spawnerPity_2 matches 100.. run clear @s radiant:spawner_tier_2 0 1 
