...
execute as @a[hasitem={item=radiant:silomult}] if score @s gems matches 5.. run scoreboard players add @s siloMultiplier 1
execute as @a[hasitem={item=radiant:silomult}] if score @s gems matches 5.. run scoreboard players remove @s gems 5