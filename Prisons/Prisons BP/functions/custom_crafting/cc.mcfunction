...
execute as @a[hasitem={location=slot.weapon.mainhand,item=radiant:mithril_drill}] run scoreboard players add @s miningFortune 120
execute as @a[hasitem={location=slot.weapon.mainhand,item=radiant:diamond_drill}] run scoreboard players add @s miningFortune 240