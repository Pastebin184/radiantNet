execute as @s if score @s money matches 100000.. if score @s level matches 250 run scoreboard players add gems 1
execute as @s if score @s money matches 100000.. if score @s level matches 250 run scoreboard players add prestige 1
