execute as @s if score @s money matches 100000.. if score @s level matches 250 run scoreboard players add @p gems 1
execute as @s if score @s money matches 100000.. if score @s level matches 250 run scoreboard players add @p prestige 1
